...
class Enemy:
    ...
    def __init__(self, name, image_filename, size, speed_multiplier, evasion_pattern):
        self.name = name
...
class Game:
    ...
    def load_enemies(self):
        ...
        enemy_definitions = [
            {"name": "Standard", "img": "enemy_standard.png", "size": 80, "speed": 1.0, "pattern": "random"},
            {"name": "Quickster", "img": "enemy_quick.png", "size": 40, "speed": 1.8, "pattern": "bounce"},
            {"name": "Tank", "img": "enemy_tank.png", "size": 120, "speed": 0.6, "pattern": "horizontal"},
            {"name": "Dodger", "img": "enemy_dodger.png", "size": 60, "speed": 1.2, "pattern": "evade"}
        ]

        for definition in enemy_definitions:
            enemy = Enemy(definition["name"], definition["img"], definition["size"], definition["speed"], definition["pattern"])
